var d3clock = function(config) {
  ...
  */
  ...
  //AH: Size and position the logo based on the clock width
  
  var logoWidth = width/20;
  var logoHeight = logoWidth*0.73;
  var logoOffSetX = logoWidth/2*-1;
  var logoOffSetY = height/5.5;
  ...
  var cLogoImage = "logo-grey.png"
	 
  var cBachgroundColour = "#000";
  
  //AH: Set the background colour
  
    window.addEventListener('load', () => {
     document.body.style.backgroundColor = cBachgroundColour;
  });
  ...
  var faces = {
      'sbb':{
          outerRing: {r:outerRadius * 1.05, stroke: oRingColour, strokeWidth: 10},       //AH: Colour constant replaced with variable
          secondsRing: {r:outerRadius * 0, fill: sRingColour},                           //AH: Colour constant replaced with variable
          secondsInnermostRing: {r:outerRadius * 0.03, fill: iRingColour},               //AH: Colour constant replaced with variable
          ...
          tickFill: function(i) {
            return cTickColour;                                                          //AH: Colour constant replaced with variable
          },
          ...
          clockHandFill: function(d){
            if (d.unit==="seconds"){
              return sHandColour;                                                        //AH: Colour constant replaced with variable
            } else if (d.unit === "minutes") {                                           //AH: Add different minute hand colour option
              return mHandColour;                                                        //AH: Colour constant replaced with variable
            } else {
              return hHandColour;                                                        //AH: Colour constant replaced with variable
            }
          },
          ...
          clockHandAdditional: function(clockHand){
            ...
            .attr("fill", sHandColour);                                                  //AH: Colour constant replaced with variable
          },
  ...
  clockGroup.append("svg:image")                                                         //AH: Add a logo onto clock face
      .attr('x', logoOffSetX)                                                            //AH: Add a logo onto clock face
      .attr('y', logoOffSetY)                                                            //AH: Add a logo onto clock face
      .attr('width', logoWidth)                                                          //AH: Add a logo onto clock face
      .attr('height', logoHeight)                                                        //AH: Add a logo onto clock face
      .attr("xlink:href", cLogoImage)                                                    //AH: Add a logo onto clock face
